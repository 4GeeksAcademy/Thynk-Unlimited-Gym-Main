...
function Resources() {
  ...
  return (
    <div className="container" style={{ maxWidth: '100%', marginLeft: '60px', marginRight: '60px' }}>
        ...
        {articles.map((article, index) => (
          ...
          >
            ...
            <div className="card-body">
              ...
              <p className="card-text"> {article.preview}
              </p>
              <a href={article.button_url} className="btn btn-dark">Read More</a>
            </div>
          </div>
        ))}
      </div>
